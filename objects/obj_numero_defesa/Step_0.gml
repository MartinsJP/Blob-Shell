...
if(grab == false)
{
 ...
 exit;
	...
	if(image_index = 0 || image_index = 1 || image_index = 2 || image_index = 3 || image_index = 4 ) 	p1.image_index = 1;
	if(image_index = 5 || image_index = 6 || image_index = 7 || image_index = 8 || image_index = 9)		p1.image_index = 7;
	if(image_index = 10 || image_index = 11 || image_index = 12 || image_index = 13 || image_index = 14) p1.image_index = 4;
